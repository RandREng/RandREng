...
namespace RandREng.Utility.Documents
{
    ...
    public class DragDropHelper
    {
        ...
        /// </summary>
        private class OleDataObject : System.Windows.Forms.IDataObject
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OleDataObject"/> class.
            /// </summary>
            /// <param name="underlyingDataObject">The underlying data object to wrap.</param>
            public OleDataObject(System.Windows.Forms.IDataObject underlyingDataObject)
            {
